    ...
    useEffect(() => {
        fetch(
        "https://images-api.nasa.gov/search?q=space technology&media_type=image"
        )
        .then((res) => res.json())
        .then((data) => {
            const rawItems = data?.collection?.items?.slice(0, 4) || [];
    ...
    return (
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pt-24 pb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-1 px-1 bg-white/5 border border-white/10">
                ...
                <div
                    key={item.id}
                    className="group relative aspect-[16/10] overflow-hidden bg-black cursor-crosshair border border-white/5"
                >
                    {item.src && (
                    <img
                        src={item.src}
                    ...
                    <div>
                        ...
                        <div className="flex gap-6 border-t border-white/10 pt-4">
                            ...
                            ([key, val]: any) => (
                                <div key={key}>
                                <p className="text-[8px] uppercase text-blue-500 font-black">
                                    {key}
                                </p>
